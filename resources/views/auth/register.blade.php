<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="flex flex-col">
        ...
        <div class="mb-5 block max-md:text-center">
            <h1 class="text-xl md:text-4xl font-bold">{{ __('Create your Account') }}</h1>
        </div>
        ...
        <div class="mt-4 flex items-center justify-between md:justify-end">
            <x-buttons.primary-button class="order-last md:ms-4">
                {{ __('Register') }}
